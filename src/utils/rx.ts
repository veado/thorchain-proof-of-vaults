// Note: All content of this file is copied from https://github.com/thorchain/asgardex-electron/blob/develop/src/renderer/helpers/stateHelper.ts
import type * as FP from 'fp-ts/lib/function';
